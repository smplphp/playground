 ...
 * @group range
 */
class InRangePredicateTest extends TestCase
{
    /**
     * @return void
     *
     * @test
     */
    public function betweenPredicateTestsCorrectlyLowInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10);
     ...
     * @test
     */
    public function betweenPredicatePerformsCorrectlyLowInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10);
     ...
     * @test
     */
    public function betweenPredicateInvokesCorrectlyLowInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10);
     ...
     * @test
     */
    public function betweenPredicateTestsCorrectlyHighInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10, true, true);
     ...
     * @test
     */
    public function betweenPredicatePerformsCorrectlyHighInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10, true, true);
     ...
     * @test
     */
    public function betweenPredicateInvokesCorrectlyHighInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10, true, true);
     ...
     * @test
     */
    public function betweenPredicateTestsCorrectlyLowExclusiveHighInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10, false, true);
     ...
     * @test
     */
    public function betweenPredicatePerformsCorrectlyLowExclusiveHighInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10, false, true);
     ...
     * @test
     */
    public function betweenPredicateInvokesCorrectlyLowExclusiveHighInclusive(): void
    {
        $predicate = Predicates::inRange(2, 10, false, true);
