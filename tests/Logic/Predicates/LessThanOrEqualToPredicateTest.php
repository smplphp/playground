 ...
 * @group numerical
 */
class LessThanOrEqualToPredicateTest extends TestCase
{
    /**
     * @return void
     *
    ...
    {
        $predicate = Predicates::lessThanOrEqualTo(10);
    ...
    {
        $predicate = Predicates::lessThanOrEqualTo(10.8);
    ...
    {
        $predicate = Predicates::lessThanOrEqualTo(new class implements Countable {
            #[Override]
            public function count(): int
            {
                return 10;
