 ...
 * @group numerical
 */
class GreaterThanOrEqualToPredicateTest extends TestCase
{
    /**
     * @return void
     *
    ...
    {
        $predicate = Predicates::greaterThanOrEqualTo(10);
    ...
    {
        $predicate = Predicates::greaterThanOrEqualTo(10.8);
    ...
    {
        $predicate = Predicates::greaterThanOrEqualTo(new class implements Countable {
            #[Override]
            public function count(): int
            {
                return 10;
