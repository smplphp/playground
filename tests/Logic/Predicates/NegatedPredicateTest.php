 ...
 * @group negated
 */
class NegatedPredicateTest extends TestCase
{
    /**
     * @return void
     *
    ...
    {
        $predicate = new Predicates\NegatedPredicate(new Predicates\EqualToPredicate(true));
    ...
    {
        $predicate = new Predicates\NegatedPredicate(new Predicates\EqualToPredicate(false));
    ...
    {
        $predicate = Predicates::negate(new Predicates\EqualToPredicate(true));
    ...
    {
        $predicate = Predicates::negate(new Predicates\EqualToPredicate(false));
