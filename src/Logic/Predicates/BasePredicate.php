...
abstract class BasePredicate extends BaseOperation implements Predicate
{
    ...
    /**
     * Create a predicate of this and another, with a logical AND on the results
     *
     * This method creates a predicate that checks if a value passes both this
     * predicate, and a second.
     *
     * @param \Smpl\Logic\Contracts\Predicate<ValType> $second
     *
     * @return \Smpl\Logic\Contracts\Predicate<ValType>
     */
    public function and(Predicate $second): Predicate
    {
        return Predicates::and($this, $second);
    }

    /**
     * Create a predicate of this and another, with a logical OR on the results
     *
     * This method creates a predicate that checks if a value passes this
     * predicate, or a second.
     *
     * @param \Smpl\Logic\Contracts\Predicate<ValType> $second
     *
     * @return \Smpl\Logic\Contracts\Predicate<ValType>
     */
    public function or(Predicate $second): Predicate
    {
